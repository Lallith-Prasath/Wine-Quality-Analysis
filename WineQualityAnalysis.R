...
p6 + geom_vline(aes(xintercept=mean(free.sulfur.dioxide)),color="blue", linetype="dashed", size=1)+ggtitle("Suplur Dioxide vs Density")+labs(x="Suplur Dioxide",y="Density")
